...
public class LogAspect {
	 ...
	 * @param joinPoint
	 */
	@Before("execution(* com.ucpaas.sms.controller..*.*(..))")
	 ...
	 * @param joinPoint
	 */
	@After("execution(* com.ucpaas.sms.controller..*.*(..))")
	 ...
	 * @throws Throwable
	 */
	@Around("execution(* com.ucpaas.sms.controller..*.*(..))")
	...
	private void printOptLog() {
		...
		logger.info("clientid={},username={},ip={},url={},beginTime={},elapsedTime={},requestParam={},reponse={}",
				...
				JSON.toJSONString(inputParamMap), JSON.toJSONString(outputParamMap));
